...
class BPMNConverter:
    ...
    def convert_file(self, input_file: str, assignees_data: Optional[List[Dict]] = None) -> str:
        ...
        # Создаем путь для результата в папке ./bpmn (аналогично get_diagram_xml.py)
        input_path = Path(input_file)
        
        # Путь к папке bpmn (на уровень выше от camunda-sync)
        ...
        output_file = str(bpmn_path / f"camunda_{input_path.name}")
        ...
        print(f"📁 Результат сохранен в папке ./bpmn: {output_file}")
