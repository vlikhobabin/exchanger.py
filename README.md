...
### 🔄 Camunda-StormBPMN Sync (`camunda-sync.py`)

**Назначение**: Синхронизация BPMN диаграмм между StormBPMN и Camunda

**Основные функции**:
- Получение списка диаграмм из StormBPMN с фильтрацией
- Скачивание BPMN схем с автоматическим сохранением XML и ответственных
- Автоматическая конвертация StormBPMN → Camunda формат с встраиванием метаданных
- Деплой сконвертированных схем в Camunda через REST API

**Основной workflow**:
1. **Получение списка процессов** - просмотр доступных диаграмм
2. **Скачивание схемы** - получение BPMN XML + список ответственных
3. **Конвертация** - преобразование в Camunda формат с встраиванием ответственных
4. **Деплой** - развертывание готовой схемы в Camunda
